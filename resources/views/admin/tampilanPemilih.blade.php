            ...
            <div class="col-lg-4 col-md-6">
              <div class="card" style="height:540px">
                ...
                <div class="card-footer">
                  ...
                  @else
                  <!-- {{ url('pilih') }}/{{$c->id}} -->
                  <span data-toggle="modal" data-target="#modalConfimation{{$c->id}}"><a class="btn btn-sm btn-block btn-primary text-white" data-toggle="tooltip" title="Pilih"><i class="fa fa-edit"></i><b> Pilih {{ $c->nama }}</b></a></span>
                  @endif
                </div>
              </div>
            </div>
...
<!-- Modal Detail -->
@foreach($calon as $c)
<div id="modalDetail{{$c->id}}" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="modalDetailLabel" aria-hidden="true">
